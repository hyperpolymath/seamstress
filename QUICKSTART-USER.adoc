...
// Replace seamstress, Seamstress — See README.adoc for details., just run, Seamstress started successfully. with actuals
= seamstress — Quick Start for Users
:toc:
:toclevels: 2

== What is seamstress?

Seamstress — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./seamstress-portable
----
...
[source]
----
Seamstress started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/seamstress/wiki
