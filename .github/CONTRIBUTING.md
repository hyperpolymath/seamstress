...
git clone <https://github.com/hyperpolymath/seamstress.git> cd
seamstress
...
toolbox create seamstress-dev toolbox enter seamstress-dev \# Install
...
seamstress/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \# Library
...
flake (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/seamstress/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/seamstress/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/seamstress/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/seamstress/labels/perimeter-3) — Community sandbox scope
