...
doctor:
    @echo "Running diagnostics for seamstress..."
...
help-me:
    @echo "=== seamstress Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/seamstress/issues/new"
    @echo ""
