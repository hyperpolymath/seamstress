...
|*Source modules* |13 |Rust seamctl (7: cli, lib, main, model, graph,
report, validate) + Elixir seamstressd (2: application, runner) + config

|*Unit tests* |2 |seamstressd_test.exs (2 assertions), no Rust tests at
all
...
* [ ] *Error handling*: No tests for malformed input, missing
dependencies
