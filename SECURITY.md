...
Replace all {{PLACEHOLDER}} values with your information:
  Seamstress     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  seamstress             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/seamstress/security/advisories/new)
...
- This repository (`hyperpolymath/seamstress`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/seamstress/security/advisories)
...
When using Seamstress, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/seamstress/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/seamstress/security/advisories/new) or 6759885+hyperpolymath@users.noreply.github.com |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/seamstress/discussions) |
...
*Thank you for helping keep Seamstress and its users safe.* 🛡️
