...
[arabic]
. Navigate to
https://github.com/hyperpolymath/seamstress/security/advisories/new[Report
a Vulnerability]
...
https://github.com/hyperpolymath/seamstress/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/seamstress/discussions[GitHub
Discussions]
...
_Thank you for helping keep Seamstress and its users safe._ 🛡️
